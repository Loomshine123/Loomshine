...
export const SignupForm = ({ onSwitchToLogin, onSignupSuccess }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!fullName || !email || !mobile || !password) {
      setErrorMsg('Please complete all required fields to create your account.');
      return;
    }
    ...
    setTimeout(() => {
      setIsLoading(false);
      if (onSignupSuccess) {
        onSignupSuccess({ fullName, email, mobile });
      } else {
        alert(`Welcome to LOOMSHINE, ${fullName}! Your account has been created.`);
        onSwitchToLogin();
      }
    }, 800);
  };
  ...
  return (
    <div className="loom-auth-form-wrap">
      <div className="loom-auth-form-header">
        <p className="loom-auth-eyebrow">JOIN LOOMSHINE</p>
        <h2 className="loom-auth-heading">CREATE AN ACCOUNT.</h2>
        <p className="loom-auth-subheading">
          Experience effortless garment care delivered directly to your door.
        </p>
      </div>
      ...
      <form className="loom-auth-form" onSubmit={handleSubmit} noValidate>
        ...
        <div className="loom-form-group">
          <label htmlFor="signup-name" className="loom-form-label">
            FULL NAME
          </label>
        ...
        {/* Email Address */}
        <div className="loom-form-group">
          <label htmlFor="signup-email" className="loom-form-label">
            EMAIL ADDRESS
          </label>
          <div className="loom-input-wrapper">
            <input
        ...
        {/* Mobile Number */}
        <div className="loom-form-group">
          <label htmlFor="signup-mobile" className="loom-form-label">
            MOBILE NUMBER
          </label>
          <div className="loom-input-wrapper">
            <input
        ...
        {/* Password */}
        <div className="loom-form-group">
          <label htmlFor="signup-password" className="loom-form-label">
            CREATE PASSWORD
          </label>
        ...
        <div className="loom-form-group loom-form-group--checkbox">
          <label className="loom-checkbox-container" htmlFor="agree-terms">
            <input
              type="checkbox"
              id="agree-terms"
            ...
            <span className="loom-checkbox-text">
              I agree to the <a href="#terms" onClick={(e) => e.preventDefault()} className="loom-legal-link">Terms of Service</a> & <a href="#privacy" onClick={(e) => e.preventDefault()} className="loom-legal-link">Privacy Policy</a>
            </span>
          </label>
        </div>
